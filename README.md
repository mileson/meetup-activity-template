...
这个开源仓库已经移除了真实参会名单、二维码、导出凭证图片、原始 Excel 文件和具体运营资源链接，只保留可运行的示例数据与示例凭证素材。
...
4. 修改 `data/review.ts` 为你的分享回顾内容。
5. 将你的凭证图片放入 `public/credentials/`。
6. 如需给凭证批量叠加二维码，可使用 `scripts/embed_qr_on_credentials.py`。
